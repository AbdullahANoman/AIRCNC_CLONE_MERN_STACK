...
import Destination from "../../NavbarToggleComponent/Detination";
import CheckTime from "../../NavbarToggleComponent/CheckTime";
import AddGuest from "../../NavbarToggleComponent/AddGuset";
import { formateDate } from "../../../utils/dateConvert";

const NavForms = ({ setRooms, setIsOpen }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      `https://airbnb-server-task-soip.vercel.app/rooms/search?${queryString}`
    )
      .then((response) => {
        if (!response.ok) {
    ...
    <>
      <div className="cursor-pointer pt-7  z-10">
        ...
        <form
          ...
          className={` rounded-3xl w-[850px]  border mt-10 grid grid-cols-11    bg-gray-100 z-20 `}
